    ...
    >
      <motion.span
        ...
        style={{
          ...
          background:
            "radial-gradient(ellipse 60% 100% at 50% 100%, oklch(0.7 0.2 12 / 0.45), oklch(0.64 0.22 25 / 0.2) 40%, transparent 70%)",
        }}
      ...
      <motion.span
        ...
        style={{
          ...
          background:
            "linear-gradient(90deg, transparent, oklch(0.7 0.2 12 / 0.95) 50%, transparent)",
        }}
...
function ToolBranch({
  ...
  return (
    <div data-tour={`tool-${tool.id}`}>
      ...
      {hasChildren && (
        <div className="ml-7 mt-0.5 space-y-0.5 border-l border-glass-border/50 pl-3">
          {tool.children!.map((c) => {
                  const subActive =
