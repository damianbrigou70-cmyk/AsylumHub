          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                className="btn-keystone inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-primary to-accent px-4 py-2 text-sm font-medium text-primary-foreground shadow-[0_8px_32px_-8px_oklch(0.64_0.22_25_/_0.4)] hover:opacity-90"
              >
      ...
      >
        <GlassPanel className="relative overflow-hidden px-4 py-3">
          <div
            ...
            style={{
              background:
                "radial-gradient(60% 80% at 20% 30%, oklch(0.64 0.22 25 / 0.18), transparent 70%), radial-gradient(50% 70% at 90% 70%, oklch(0.72 0.19 35 / 0.18), transparent 70%)",
            }}
          />
    ...
    <div
      ...
      style={
        biggestDrop
          ? {
              background:
                "linear-gradient(135deg, oklch(0.8 0.16 55 / 0.28), oklch(0.72 0.19 35 / 0.14))",
              boxShadow:
                "0 0 0 1px oklch(0.8 0.16 55 / 0.5), 0 0 24px -4px oklch(0.8 0.16 55 / 0.55)",
            }
          : undefined
      }
    >
      <span
        className="h-1.5 w-1.5 rounded-full"
        style={{ background: biggestDrop ? "oklch(0.8 0.16 55)" : hue }}
      />
      <span>→ {label}</span>
  ...
  return (
    ...
    >
      <span
        ...
        style={{ boxShadow: "0 0 8px oklch(0.64 0.22 25)" }}
      />
      <span>
  ...
  return (
    <GlassPanel className="relative overflow-hidden p-10 text-center">
      <div
        ...
        style={{
          background:
            "radial-gradient(50% 60% at 50% 20%, oklch(0.64 0.22 25 / 0.18), transparent 70%)",
        }}
      />
        ...
        >
          ...
          <div className="mt-6">
            <button
              onClick={submit}
              disabled={saving}
              className="btn-keystone w-full rounded-xl bg-gradient-to-r from-primary to-accent px-4 py-3 text-sm font-semibold text-primary-foreground shadow-[0_8px_32px_-8px_oklch(0.64_0.22_25_/_0.45)] transition hover:opacity-90 disabled:opacity-50"
            >
