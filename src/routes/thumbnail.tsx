    ...
    <div className="fixed inset-0 grid place-items-center overflow-hidden bg-[color:var(--color-ink)]">
      ...
      >
        ...
        <div className="absolute inset-0 z-[5]" aria-hidden>
          ...
          <Hex {...p(-1, 0)} hue={275}>
            <PrimaryHexContent tier="Combat & Intel" name="Services" hue={275} icon={<IconUtm size={28} />} />
          </Hex>
          <Hex {...p(1, 0)} hue={200}>
            <PrimaryHexContent tier="Strikes" name="Air Support" hue={200} icon={<IconFunnel size={28} />} />
          </Hex>
          <Hex {...p(0, 1)} hue={150}>
            <PrimaryHexContent tier="Base Ops" name="Base Ops" hue={150} icon={<IconCampaign size={28} />} />
          </Hex>
          <Hex {...p(-2, 0)} hue={275}>
            ...
            <svg viewBox="0 0 200 36" className="mt-2 h-8 w-full" aria-hidden>
              <defs>
                <linearGradient id="tn-spark" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="oklch(0.64 0.22 25)" stopOpacity="0.45" />
                  <stop offset="100%" stopColor="oklch(0.64 0.22 25)" stopOpacity="0" />
                </linearGradient>
              </defs>
              <path
          ...
          <div className="w-[216px] rounded-2xl border border-glass-border bg-glass-strong p-4 backdrop-blur-md" style={{ boxShadow: "var(--shadow-glass)" }}>
            ...
            <div className="mt-3.5 h-1.5 w-full rounded-full bg-[oklch(1_0_0_/_0.08)]">
              <div
                ...
                style={{ background: "linear-gradient(90deg, oklch(0.64 0.22 25), oklch(0.72 0.19 35))" }}
              />
            </div>
              ...
              return (
                <div
                  ...
                  style={{
                    left: x,
                    top: y,
                    borderColor: c.amber ? "oklch(0.8 0.16 55 / 0.5)" : "var(--glass-border)",
                    background: c.amber ? "oklch(0.8 0.16 55 / 0.12)" : "var(--glass-strong)",
                    color: c.amber ? "oklch(0.9 0.13 88)" : "oklch(0.9 0.01 260)",
                    boxShadow: c.amber ? "0 0 22px -4px oklch(0.8 0.16 55 / 0.45)" : undefined,
                  }}
                >
                  {c.text}
                </div>
