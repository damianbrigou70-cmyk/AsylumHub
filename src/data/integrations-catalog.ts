...
export const INTEGRATIONS: IntegrationEntry[] = [
  ...
  // ============= COMMS (Discord / Nitrado game servers) =============
  {
    id: "discord",
    name: "Discord",
    slug: "discord",
    category: "Comms",
    method: "api-key",
    blurb: "Bot posts live server status to a channel; members log in with Discord.",
    useCase: "post DayZ server status embeds to a Discord channel and let members sign in via Discord OAuth",
    placement: "the Servers page (/servers) and the login screen",
    docsUrl: "https://discord.com/developers/docs/intro",
    dashboardUrl: "https://discord.com/developers/applications",
    apiBase: "https://discord.com/api/v10",
    authHeader: "Authorization: Bot <DISCORD_BOT_TOKEN>",
  ...
  },
  {
    ...
    category: "Comms",
    method: "api-key",
    blurb: "Live status, player counts, and map for a rented DayZ game server.",
    useCase: "fetch live gameserver status (players, map, ports) for a Nitrado-hosted DayZ server",
    placement: "the Servers page (/servers)",
    docsUrl: "https://doc.nitrado.net/",
    dashboardUrl: "https://server.nitrado.net/en-GB/account/api",
    apiBase: "https://api.nitrado.net",
    authHeader: "Authorization: Bearer <NITRADO_API_TOKEN>",
    testEndpoint: "/services/{serviceId}/gameservers",
  },
];
