...
const AppToolsNpcShopRoute = AppToolsNpcShopRouteImport.update({
  id: '/tools/npc-shop',
  path: '/tools/npc-shop',
  getParentRoute: () => AppRoute,
} as any)
const AppToolsNpcMapClickerRoute = AppToolsNpcMapClickerRouteImport.update({
  id: '/tools/npc-map-clicker',
  path: '/tools/npc-map-clicker',
  getParentRoute: () => AppRoute,
} as any)
...
const AppToolsBaseMapClickerRoute = AppToolsBaseMapClickerRouteImport.update({
  id: '/tools/base-map-clicker',
  path: '/tools/base-map-clicker',
  getParentRoute: () => AppRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_app/tools/npc-shop': {
      id: '/_app/tools/npc-shop'
      path: '/tools/npc-shop'
      fullPath: '/tools/npc-shop'
      preLoaderRoute: typeof AppToolsNpcShopRouteImport
      parentRoute: typeof AppRoute
    }
    '/_app/tools/npc-map-clicker': {
      id: '/_app/tools/npc-map-clicker'
      path: '/tools/npc-map-clicker'
      fullPath: '/tools/npc-map-clicker'
      preLoaderRoute: typeof AppToolsNpcMapClickerRouteImport
      parentRoute: typeof AppRoute
    }
    '/_app/tools/list-cleaner': {
    ...
    '/_app/tools/base-map-clicker': {
      id: '/_app/tools/base-map-clicker'
      path: '/tools/base-map-clicker'
      fullPath: '/tools/base-map-clicker'
      preLoaderRoute: typeof AppToolsBaseMapClickerRouteImport
      parentRoute: typeof AppRoute
    }
    '/_app/tools/all-utms': {
