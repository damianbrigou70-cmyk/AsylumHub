      ...
      <style>{`
        ...
        .htl-hex .htl-face {
          ...
          box-shadow:
            ...
            0 10px 24px -10px oklch(0.06 0.02 25 / 0.9);
        ...
        .htl-hex:hover .htl-face {
          box-shadow:
            ...
            0 14px 32px -10px oklch(0.06 0.02 25 / 0.95),
        ...
        .htl-hex.is-active .htl-face {
          box-shadow:
            ...
            inset 0 -1px 0 oklch(0 0 0 / 0.5),
            0 14px 36px -8px oklch(0.06 0.02 25 / 0.95),
        ...
        .htl-sat.is-add .htl-face {
          background:
            linear-gradient(160deg,
              oklch(0.22 0.02 25 / 0.85) 0%,
              oklch(0.14 0.02 25 / 0.95) 100%);
        }
